                            ...
                            <div class="collapse navbar-collapse" id="navbarsExample04">
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    @if (Auth::check() && Auth::user()->vai_tro === 'admin')
                                        <a class="nav-link" href="{{ route('dashboard') }}">AdminPage</a>
                                    @endif
                                    <li class="nav-item">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="img_box">
                                <figure><img src="{{ asset('css/home/images/images.png') }}" alt="#" />
                                </figure>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="img_box">
                                <figure><img src="{{ asset('css/home/images/images1.png') }}" alt="#" />
                                </figure>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="img_box">
                                <figure><img src="{{ asset('css/home/images/images2.png') }}" alt="#" />
                                </figure>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row d_flex">
                ...
                <div class="col-md-6">
                    <div class="our_box">
                        ...
                        <a class="read_more"
                            href="{{ Auth::check() ? route('datphong') : route('user_login') }}">Đăng kí phòng</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="contact" class="about">
        <div class="container-fluid">
            <div class="row d_flex">
                ...
                <div class="col-md-6">
                    <div class="about_img">
                        <figure><img src="{{ asset('css/home/images/customer-support.jpg') }}" alt="#" />
                        </figure>
                    </div>
                </div>
            </div>
