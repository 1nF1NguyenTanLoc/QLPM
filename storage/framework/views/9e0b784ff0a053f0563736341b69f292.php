<head>
    ...
    <title>Sửa người dùng - HUIT - Quản lý phòng máy</title>
                    ...
                    <form method="POST" action="<?php echo e(route('admin.users.update', $user->id)); ?>">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12"><label class="labels">ID Giảng Viên</label><input type="text"
                                    class="form-control" name="id" value="<?php echo e($user->id); ?>" required autofocus readonly></div>
                            <div class="col-md-12"><label class="labels">Họ Tên</label><input type="text"
                                    class="form-control" name="name" value="<?php echo e($user->name); ?>" required autofocus></div>
                            ...
                            <div class="col-md-12"><label class="labels">Quyền</label>
                                <select id="phai" class="form-control" name="vai_tro" required>
                                    ...
                                    <option value="admin" <?php echo e($user->vai_tro == '1' ? 'admin' : ''); ?>>Quản Lý</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-12"><label class="labels">Mật khẩu</label><input type="password"
                                    class="form-control" name="password" value="" placeholder="<Mật khẩu hiện tại>"></div>
                        </div>
