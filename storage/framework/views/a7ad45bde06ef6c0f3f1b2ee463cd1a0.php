        ...
        <div class="row">
            ...
            <div class="col-md-5 border-right">
                <div class="p-3 py-5">
                    ...
                    <form method="POST" action="<?php echo e(route('dangki_post')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="row mt-3">
						...
						<div style="text-align: right;margin-top: 10px">
							...
							<a style="text-decoration: none" href="<?php echo e(route('user_login')); ?>" class="btn btn-primary">Đăng nhập</a>
						</div>
                </div>
                </form>
            </div>
...
<!-- end footer --><?php /**PATH C:\Users\dh520\OneDrive\Desktop\qlpm\resources\views/user/dangki.blade.php ENDPATH**/ ?>