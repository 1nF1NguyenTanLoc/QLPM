        ...
        <div class="row">
            <div class="col-md-3 border-right">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5"
                        width="150px"
                        <?php if($user->phai): ?> src="https://cdn5.vectorstock.com/i/1000x1000/01/69/businesswoman-character-avatar-icon-vector-12800169.jpg" alt="Woman Avatar"
                        <?php else: ?>
                        src="https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg" alt="Man Avatar"> <?php endif; ?>
                        <span class="font-weight-bold"><?php echo e($user->name); ?></span><span
                        class="text-black-50"><?php echo e($user->email); ?></span><span> </span></div>
            </div>
                    ...
                    <form method="POST" action="<?php echo e(route('admin.users.update', $user->id)); ?>">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12"><label class="labels">ID Giảng Viên</label><input type="number"
                                    class="form-control" name="id" value="<?php echo e($user->id); ?>" required autofocus
                                    readonly></div>
                            <div class="col-md-12"><label class="labels">Họ Tên</label><input type="text"
                                    class="form-control" name="name" value="<?php echo e($user->name); ?>" required autofocus>
                            </div>
                            <div class="col-md-12"><label class="labels">Số điện thoại</label><input type="number"
                                    class="form-control" name="sdt" value="<?php echo e($user->sdt); ?>" required></div>
                            ...
                            <div class="col-md-12"><label class="labels">Email ID</label><input type="email"
                                    class="form-control" name="email" value="<?php echo e($user->email); ?>" required></div>
                            <div class="col-md-12"><label class="labels">Quyền</label>
                                <select id="phai" class="form-control" name="vai_tro" required>
                                    <option value="giang_vien" <?php echo e($user->vai_tro == 'giang_vien' ? 'selected' : ''); ?>>
                                        Giảng Viên</option>
                                    <option value="admin" <?php echo e($user->vai_tro == 'admin' ? 'selected' : ''); ?>>Quản Lý
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-12"><label class="labels">Khoa</label>
                                <select id="khoa" class="form-control" name="khoa" required>
                                    <option value="Công Nghệ Thông Tin"
                                        <?php echo e($user->khoa == 'Công Nghệ Thông Tin' ? 'selected' : ''); ?>>Công Nghệ Thông
                                        Tin</option>
                                    <option value="Quản Trị Kinh Doanh"
                                        <?php echo e($user->khoa == 'Quản Trị Kinh Doanh' ? 'selected' : ''); ?>>Quản Trị Kinh
                                        Doanh</option>
                                    <option value="Công Nghệ Thực Phẩm"
                                        <?php echo e($user->khoa == 'Công Nghệ Thực Phẩm' ? 'selected' : ''); ?>>Công Nghệ Thực
                                        Phẩm</option>
                                    <option value="Kỹ Sư Xây Dựng"
                                        <?php echo e($user->khoa == 'Kỹ Sư Xây Dựng' ? 'selected' : ''); ?>>Kỹ Sư Xây Dựng</option>
                                </select>
                            </div>
...
<?php /**PATH C:\Users\dh520\OneDrive\Desktop\qlpm\resources\views/admin/users/updateNguoidung.blade.php ENDPATH**/ ?>